package section12.challenges.stockItems;
...
public class StockItem implements Comparable<StockItem> {
    ...
    public void reserveItem(int quantity) {
        ...
        if(this.quantityStock >= newReservedQuantity) {
            this.reserved = newReservedQuantity;
        } else System.out.println("There is no enough quantity in stock");
    }
    ...
    public void unreserveItem(int quantity) {
        if (this.reserved >= quantity) {
            ...
            System.out.println("Cannot remove " + quantity + ". There is " + this.reserved + " items reserved.");
        }
    }
